...
var isLocalEvent = true;
function isEventLocal()
{
    let isLocal = isLocalEvent;
    isLocalEvent = true;
    return isLocal;
}
...
function tabSelect1(barItem)
{
    setTimeout(() => {
        ...
        currentTab = barItem;
        doSelected(barItem,isEventLocal());
        observer.unobserve();
     }, "0");
}
...
function doSelected(item, forward)
{
    ...
    const addlProperties = ', "tabBarItems":[{"title":"Listen Now", "tag": 0, "hideNavBar": false,"navBar": {"title":"Listen Now","appearance": {"prefersLargeTitles":true }}, "image": {"type": "symbol","name": "play.circle"}},{"title":"Radio", "tag": 1, "hideNavBar": false,"navBar": {"title":"Radio"},"image": {"type": "symbol","name": "dot.radiowaves.left.and.right"}},{"title":"Library", "tag": 2,"hideNavBar": false,"navBar": {"title":"Recently Added","appearance": {"prefersLargeTitles":true}}, "image": {"type": "symbol","name": "rectangle.stack"}}]}';
