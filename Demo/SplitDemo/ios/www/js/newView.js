...
{
   {
       ...
       switch (option)
       {
           ...
           case "three-column": //triple column
               viewPropJSON = '{"primaryTitle":"Primary","fullscreen":true,"primaryURL":"triplePrimary.html","topColumnForCollapsingToProposedTopColumn":"primary","showsSecondaryOnlyButton":true,"preferredDisplayMode":"oneOverSecondary","secondaryTitle":"Secondary","secondaryURL":"tripleSecondary.html","style":"tripleColumn","supplementaryTitle":"Supplementary","supplementaryURL":"tripleSupplementary.html","tintColor":[1,255,3,1],"backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
           ...
           case "native-list": //native list, double column
               viewPropJSON = '{"fullscreen":true,"primaryTitle":"Not Music", "primaryURL":"doublePrimary.html", "viewConfig": {"primary": "collectionList" }, "secondaryTitle":"Secondary", "secondaryURL":"collectionSecondary.html", "style":"doubleColumn", "preferredSplitBehavior":"automatic", "usesCompact":true, "preferredDisplayMode":"oneOverSecondary", "primaryEdge":"leading","backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
