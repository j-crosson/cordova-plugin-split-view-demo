...
{
   {
       ...
       switch (option)
       {
           ...
           case "native-list": //native list, double column
               viewPropJSON = '{"fullscreen":true,"primaryTitle":"Not Music", "primaryURL":"doublePrimary.html", "viewConfig": {"primary": "collectionList" }, "secondaryTitle":"Secondary", "secondaryURL":"collectionSecondary.html", "style":"doubleColumn", "preferredSplitBehavior":"tile", "usesCompact":true, "preferredDisplayMode":"oneBesideSecondary", "primaryEdge":"leading","backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
           ...
           case "large-title": //compact tabView, large titles
               viewPropJSON = '{"fullscreen":true,"primaryURL":"compactPrimaryInsetNever.html","primaryTitle":"Primary","secondaryURL":"compactSecondaryInsetNever.html", "secondaryTitle":"Secondary", "style":"doubleColumn", "preferredSplitBehavior":"automatic","preferredDisplayMode":"oneOverSecondary","usesCompact":true, "backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
           ...
           case "large-inset-auto": //compact tabView, large titles auto inset
               viewPropJSON = '{"fullscreen":true, "primaryURL":"compactPrimaryInsetNever.html", "primaryTitle":"Primary","secondaryURL":"compactSecondaryInsetAuto.html", "secondaryTitle":"Secondary", "style":"doubleColumn", "preferredSplitBehavior":"automatic","preferredDisplayMode":"oneOverSecondary","usesCompact":true, "backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
           ...
           case "small-title": //compact tabView, small titles
               viewPropJSON = '{"fullscreen":true,"primaryURL":"compactPrimaryInsetNever.html","primaryTitle":"Primary","secondaryURL":"compactSecondaryInsetNever.html", "secondaryTitle":"Secondary", "style":"doubleColumn", "preferredSplitBehavior":"tile","preferredDisplayMode":"oneBesideSecondary","usesCompact":true, "backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
               ...
               break;
         case "clearbkg":
               viewPropJSON = '{"fullscreen":true,"primaryURL":"compactPrimaryTransparent.html","primaryTitle":"Primary","secondaryURL":"compactSecondaryTransparent.html", "secondaryTitle":"Secondary", "style":"doubleColumn", "preferredSplitBehavior":"automatic","preferredDisplayMode":"oneOverSecondary","usesCompact":true, "backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
               viewPropCompact = '{"compactURL":"compactInsetNever.html", "tabBar": {"tabBarAppearance": {"background": "transparent", "lockBackground": true } },  "tabBarItems":[{"title":"title1", "tag": 0, "hideNavBar": false,"navBar": {"title":"Item1","appearance": {"prefersLargeTitles":true }}, "image": {"type": "symbol","name": "1.circle"}},{"title":"title2", "tag": 1, "hideNavBar": false,"navBar": {"title":"Item2"},"image": {"type": "symbol","name": "2.circle"}},{"title":"title3", "tag": 2,"hideNavBar": false,"navBar": {"title":"Item3","appearance": {"prefersLargeTitles":true}}, "image": {"type": "symbol","name": "3.circle"}}], "backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]}';
               viewPropPrimary = '{"opaque": false, "navBarAppearance": {"prefersLargeTitles":true}, "backgroundColor":[' + clearRed+','+ clearGreen+ ',' + clearBlue+ ',' + '1]}';
               viewPropSecondary = '{"preventHorizScroll":true,"horizScrollBarInvisible":true ,"navBarAppearance": {"prefersLargeTitles":true},"backgroundColor":[' + redBackground+','+ greenBackground+ ',' + blueBackground+ ',' + '1]} ';
               viewPropSup = null;
               break;
         case "exit":
               return;
